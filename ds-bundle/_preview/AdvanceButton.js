...
var __dsPreview = (() => {
  ...
  var require_react_shim = __commonJS({
    "shim:react-shim"(exports, module) {
      ...
      function jsx2(t3, p, k) {
        var c = p && p.children;
        return c === void 0 ? R.createElement(t3, np(p, k)) : R.createElement(t3, np(p, k), c);
      }
      function jsxs2(t3, p, k) {
        return R.createElement.apply(R, [t3, np(p, k)].concat(p.children));
      }
      module.exports = R;
      module.exports.jsx = jsx2;
      module.exports.jsxs = jsxs2;
      module.exports.jsxDEV = function(t3, p, k, s) {
        return (s ? jsxs2 : jsx2)(t3, p, k);
      };
      module.exports.Fragment = R.Fragment;
    }
  });

  // .design-sync/previews/AdvanceButton.tsx
  var AdvanceButton_exports = {};
  __export(AdvanceButton_exports, {
    Small: () => Small,
    States: () => States
  });
  init_define_import_meta_env();
  ...
  var sampleTask = {
    ...
    description: "Assemble the new homepage from the component library.",
    durationHours: 20,
    status: "TODO",
    isBlocked: false,
    complexity: "MEDIUM",
  ...
  var t2 = (o) => ({ ...sampleTask, ...o });
  var States = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 12, alignItems: "center", flexWrap: "wrap" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.AdvanceButton, { task: t2({ status: "TODO", isBlocked: false }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.AdvanceButton, { task: t2({ status: "TODO", isBlocked: true }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.AdvanceButton, { task: t2({ status: "IN_PROGRESS" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.AdvanceButton, { task: t2({ status: "COMPLETED" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.AdvanceButton, { task: t2({ status: "EXPIRED" }) })
  ] });
  var Small = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 12, alignItems: "center", flexWrap: "wrap" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.AdvanceButton, { small: true, task: t2({ status: "TODO", isBlocked: false }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.AdvanceButton, { small: true, task: t2({ status: "TODO", isBlocked: true }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.AdvanceButton, { small: true, task: t2({ status: "IN_PROGRESS" }) })
  ] });
  return __toCommonJS(AdvanceButton_exports);
})();
