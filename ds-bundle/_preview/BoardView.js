...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/BoardView.tsx
  var BoardView_exports = {};
  __export(BoardView_exports, {
    Board: () => Board
  });
  init_define_import_meta_env();
  ...
  installPreviewMock();
  var Board = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.BoardView, {});
  return __toCommonJS(BoardView_exports);
})();
