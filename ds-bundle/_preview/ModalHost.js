...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/ModalHost.tsx
  ...
  installPreviewMock();
  var InFlow = ({ children }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { position: "relative", minHeight: 120 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("style", { children: `.modal-root { position: static; } .modal-backdrop { display: none; } .modal { max-height: none; margin: 0 auto; }` }),
    children
  ] });
  var OpenTaskForm = () => {
    const { openCreate } = (0, ds_exports.useUI)();
    (0, import_react.useEffect)(() => {
      openCreate();
    }, [openCreate]);
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ModalHost, {});
  };
  var NewTask = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InFlow, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(OpenTaskForm, {}) });
  var OpenProjectForm = () => {
    const { openCreateProject } = (0, ds_exports.useUI)();
    (0, import_react.useEffect)(() => {
      openCreateProject();
    }, [openCreateProject]);
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ModalHost, {});
  };
  var NewProject = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InFlow, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(OpenProjectForm, {}) });
  var OpenConfirm = () => {
    const { confirm } = (0, ds_exports.useUI)();
    (0, import_react.useEffect)(() => {
      void confirm({
  ...
  var ConfirmDelete = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InFlow, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(OpenConfirm, {}) });
  return __toCommonJS(ModalHost_exports);
})();
