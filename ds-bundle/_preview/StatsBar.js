...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/StatsBar.tsx
  var StatsBar_exports = {};
  __export(StatsBar_exports, {
    Default: () => Default
  });
  init_define_import_meta_env();
  ...
  installPreviewMock();
  var Default = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.StatsBar, {});
  return __toCommonJS(StatsBar_exports);
})();
