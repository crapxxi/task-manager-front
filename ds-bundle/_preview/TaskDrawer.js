...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/TaskDrawer.tsx
  var TaskDrawer_exports = {};
  __export(TaskDrawer_exports, {
    Open: () => Open
  });
  init_define_import_meta_env();
  ...
  installPreviewMock();
  var OpenDrawer = () => {
    const { select } = (0, ds_exports.useUI)();
    const { byId } = (0, ds_exports.useTasks)();
    (0, import_react.useEffect)(() => {
      if (byId.has(5)) select(5);
    }, [byId, select]);
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.TaskDrawer, {});
  };
  var Open = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { position: "relative" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("style", { children: `.scrim { display: none; } .drawer { position: static; width: 420px; height: auto; max-height: none; }` }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(OpenDrawer, {})
  ] });
  return __toCommonJS(TaskDrawer_exports);
})();
